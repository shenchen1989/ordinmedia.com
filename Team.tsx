...
const advisors = [
  ...
  },
  {
    ...
    description: '著名丹麦女高音歌唱家，丹麦皇家音乐学院声乐教授兼声乐系主任，二十年来致力于培养新一代国际声乐人才。',
    descriptionEn: 'Renowned Danish soprano, Professor of Voice and Head of the Vocal Department at RDAM, dedicated to training international vocal talent.',
    descriptionDa: 'Anerkendt dansk sopran, professor i sang og leder af sangafdelingen ved DKDM, dedikeret til at uddanne internationale sangtalenter.',
  ...
  },
  {
    ...
    description: '瑞典卡尔斯塔德大学教授，挪威国家歌剧院与芭蕾舞团 WOYS 负责人。',
    descriptionEn: 'Professor at Karlstad University, Sweden. Head of WOYS, The Norwegian National Opera and Ballett!',
    descriptionDa: 'Professor ved Karlstad Universitet, Sverige. Leder af WOYS, Den Norske Opera & Ballett!',
